 ...
 */
public class BandFragment extends android.support.v4.app.Fragment {
    ...
    public static BandFragment newInstance(int initValue) {
...
//                버튼 누름 이벤트
        ...
        public void onBindViewHolder(final ViewHolder holder, final int position) {
            ...
            switch (serverData.get(2).toString()) {
                case "1": setData(holder,serverData);return;
                default:return;
            }
        }
